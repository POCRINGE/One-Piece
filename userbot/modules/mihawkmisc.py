...
async def _(event):
    ...
    if c.admin_rights or c.creator:
        ...
        await event.edit("Sensei Anda harus memerlukan izin Admin untuk melakukan perintah ini")
...
async def weebify(event):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await event.edit("`Sensei, Teks Apa Yang Harus Saya Weebify Kan?`")
        return
...
async def thicc(bolded):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await bolded.edit("`Sensei, Teks Apa Yang Harus Saya Bold Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
async def mediv(medievalx):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await medievalx.edit("`Sensei, Teks Apa Yang Harus Saya Medibold Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
async def doublex(doublestrucktx):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await doublestrucktx.edit("`Sensei, Teks Apa Yang Harus Saya Double Struck Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
async def cursive2(cursivebolded):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await cursivebolded.edit("`Sensei, Teks Apa Yang Harus Saya Cursive Bold Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
async def medival22(medivallite):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await medivallite.edit("`Sensei Teks Apa Yang Harus Saya Medival Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
async def xcursive(cursivelite):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await cursivelite.edit("`Sensei, Teks Apa Yang Harus Saya Cursive Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
